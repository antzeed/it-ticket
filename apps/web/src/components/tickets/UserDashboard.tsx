                  ...
                  <Link href={`/tickets/${ticket.id}`} className="block px-6 py-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex flex-col items-end space-y-2 flex-shrink-0">
                        <span className={`px-3 py-1 text-xs font-bold rounded-full ${ticket.status === 'OPEN' ? 'bg-red-50 text-red-600 border border-red-200' :
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="ซอฟต์แวร์ / โปรแกรม (เช่น โปรแกรมค้าง, ติดตั้งแอป, Error)"> ซอฟต์แวร์ / โปรแกรม (เช่น โปรแกรมค้าง, ติดตั้งแอป, Error)</option>
                <option value="บัญชีผู้ใช้ / รหัสผ่าน (เช่น ลืมรหัสผ่าน, ถูกล็อค)">บัญชีผู้ใช้ / รหัสผ่าน (เช่น ลืมรหัสผ่าน, ถูกล็อค)</option>
                <option value="ปริ้นเตอร์ / สแกนเนอร์ (เช่น พิมพ์ไม่ออก, หมึกหมด, กระดาษติด)">ปริ้นเตอร์ / สแกนเนอร์ (เช่น พิมพ์ไม่ออก, หมึกหมด)</option>
            ...
            <button
              ...
              className={`w-full flex justify-center py-4 px-4 rounded-xl text-[16px] font-bold transition-all ${(loading || !title || !description)
